...
/datum/map/tempeterra/roundend_player_status()
...
/datum/map/tempeterra/ship_jump()
...
/datum/map/tempeterra/roundend_summary(list/data)
	var/desc
...
/datum/map/tempeterra/do_interlude_teleport(atom/movable/target, atom/destination, duration = 30 SECONDS, precision, type)
