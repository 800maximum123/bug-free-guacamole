...
//	Элемент списка, или же самое ДЕЙСТВИЕ - отвечает за то, что произойдёт на этом этапе катсцены
...
//
//	 - null
//	 * Не делает ничего, но всё ещё применяет задержку, назначенную элементу.
