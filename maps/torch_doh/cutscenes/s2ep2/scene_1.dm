...
/datum/modular_cutscene/s2ep2sc1/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('maps/torch_doh/cutscenes/sounds/ambienceriver.ogg', volume = 50), null) = 2 SECONDS,
		...
		PLAY_SOUND(sound('maps/torch_doh/cutscenes/sounds/IBO - Survivor.mp3', volume = 50), null) = 4 SECONDS,
