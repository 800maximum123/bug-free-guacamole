...
/datum/modular_cutscene/s2ep1sc2/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('sound/effects/fastbeep.ogg', volume = 70), null),
...
/datum/modular_cutscene/s2ep1sc3/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('sound/machines/flatline.ogg', volume = 15), null),
		...
		PLAY_SOUND(sound('sound/machines/flatline.ogg', volume = 15), null) = 2 SECONDS,
