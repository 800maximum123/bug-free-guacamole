...
/datum/modular_cutscene/s2ep1sc14/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('sound/effects/footstep/plating5.ogg', volume = 70), null),
		MOVE_ACTOR(actor("Фройз - Сцена 14"), EAST) = 2 SECONDS,
		PLAY_SOUND(sound('sound/effects/footstep/plating2.ogg', volume = 70), null),
		MOVE_ACTOR(actor("Фройз - Сцена 14"), EAST) = 2 SECONDS,
		...
		PLAY_SOUND(sound('sound/effects/footstep/plating3.ogg', volume = 70), null),
		MOVE_ACTOR(actor("Фройз - Сцена 14"), WEST),
		TALK_ACTOR(actor("Фройз - Сцена 14"), "!убирает устройство.") = 1 SECONDS,
		PLAY_SOUND(sound('sound/effects/footstep/plating1.ogg', volume = 70), null),
...
/datum/modular_cutscene/s2ep1sc15/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('sound/effects/footstep/water1.ogg', volume = 70), null),
		...
		PLAY_SOUND(sound('mods/emote_panel/sound/laugh_female_2.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('mods/emote_panel/sound/giggle_female_1.ogg', volume = 20), null) = 3 SECONDS,
...
/datum/modular_cutscene/s2ep1sc16/setup_actions(...)
	actions = list(
		...
		ADD_SCREEN(/blackout/animated_better/nofade) = 1 SECONDS,
		REMOVE_SCREEN(/blackout/animated_better/nofade, 3 SECONDS) = 1 SECONDS,
		PLAY_SOUND(sound('sound/items/welderactivate.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('sound/items/Welder2.ogg', volume = 20), null) = 1 SECONDS,
		PLAY_SOUND(sound('sound/items/welderdeactivate.ogg', volume = 20), null),
		TALK_ACTOR(actor("Оливия - Сцена 16"), "Радиоактивные отходы - это МЕНЬШАЯ из наших проблем.") = 4 SECONDS,
		PLAY_SOUND(sound('sound/items/rped.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('sound/items/Welder.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('sound/items/scrape_clunk.ogg', volume = 20), null),
...
/datum/modular_cutscene/s2ep1sc18/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('maps/torch_doh/cutscenes/sounds/shorter_siren.ogg', volume = 5), null),
		PLAY_SOUND(sound('sound/mecha/lowpowernano.ogg', volume = 10), null),
...
/datum/modular_cutscene/s2ep1sc19/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('sound/effects/footstep/asteroid5.ogg', volume = 70), null),
		MOVE_ACTOR(actor("Рифлер - Сцена 19"), NORTH) = 1 SECONDS,
		PLAY_SOUND(sound('sound/effects/footstep/asteroid1.ogg', volume = 70), null),
