...
/datum/modular_cutscene/s2ep3sc12/setup_actions(...)
	actions = list(
		...
		PLAY_SOUND(sound('packs/infinity/sound/effects/radio4.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('packs/infinity/sound/effects/radio1.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('sound/effects/walkieon.ogg', volume = 20), null),
		...
		PLAY_SOUND(sound('maps/torch_doh/cutscenes/sounds/hathaway.ogg', volume = 30), null),
		PLAY_SOUND(sound('sound/effects/explosionfar.ogg', volume = 40), null),
		FLASH_EVERYONE,
