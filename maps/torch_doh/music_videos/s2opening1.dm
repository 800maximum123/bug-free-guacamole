...
/proc/fds2op1_full()
	start_cutscene(/datum/modular_cutscene/fds2op1_full)
...
/datum/modular_cutscene/fds2op1_full/setup_actions(...)
	actions = list(
		...
		MOVE_CAMERA_MOB(189,73),

		CALL_GLOB(opening1_line16) = 2 SECONDS,

		MOVE_CAMERA_MOB(191,54),
