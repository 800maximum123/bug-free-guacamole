...
/datum/map/gaia/get_map_info()
	...
	. += "This map features asymmetrical gameplay: SCG irregulars of <b>[station_name]</b> operate from makeshift base and engage in guerrilla tactics, while GCC forces of <b>[evil_station_name]</b> maintain martial law."
