/obj/item/clothing/under/sestris_pmc
	...
	icon = 'maps/gaia/icons/pmc_gear.dmi'
	item_icons = list(
		slot_l_hand_str = "under_utility_held_l",
		slot_r_hand_str = "under_utility_held_r",
		slot_w_uniform_str = 'maps/gaia/icons/pmc_gear_mob.dmi'
	)
	sprite_sheets = list()
...
/obj/item/clothing/suit/armor/pcarrier/pmc
	...
	item_icons = list(slot_wear_suit_str = 'maps/gaia/icons/pmc_gear_mob.dmi')
...
/obj/item/clothing/accessory/storage/pouches/pmc
	...
	accessory_icons = list(
		slot_tie_str = 'maps/gaia/icons/pmc_gear_mob.dmi',
		slot_wear_suit_str = 'maps/gaia/icons/pmc_gear_mob.dmi'
	)
...
/obj/item/clothing/accessory/helmet_cover/pmc
	...
	accessory_icons = list(
		slot_tie_str = 'maps/gaia/icons/pmc_gear_mob.dmi',
		slot_head_str = 'maps/gaia/icons/pmc_gear_mob.dmi'
	)
