...
/datum/map/lightbrigade // setting the map to use this list
	security_state = /singleton/security_state/default/lbrigdept

//map alert levels. Refer to security_state.dm.
/singleton/security_state/default/lbrigdept
	all_security_levels = list(/singleton/security_level/default/lbrigdept/code_green, /singleton/security_level/default/lbrigdept/code_violet, /singleton/security_level/default/lbrigdept/code_orange, /singleton/security_level/default/lbrigdept/code_blue, /singleton/security_level/default/lbrigdept/general_quarters, /singleton/security_level/default/lbrigdept/code_red, /singleton/security_level/default/lbrigdept/code_delta)

/singleton/security_level/default/lbrigdept
	icon = 'maps/torch/icons/security_state.dmi'

/singleton/security_level/default/lbrigdept/code_green
	name = "code green"
...
/singleton/security_level/default/lbrigdept/code_green/switching_down_to()
...
/singleton/security_level/default/lbrigdept/code_violet
	name = "code violet"
	alarm_level = "on"
...
/singleton/security_level/default/lbrigdept/code_orange
	name = "code orange"
	alarm_level = "on"
...
/singleton/security_level/default/lbrigdept/code_blue
	name = "code blue"
	icon = 'icons/misc/security_state.dmi'
	alarm_level = "on"
	...
	up_description = "A major non-combat security emergency has developed. Masters-at-Arms and Armsmen are to report to their supervisors for orders."
	down_description = "Code blue procedures are now in effect. Masters-at-Arms and Armsmen are to report to their supervisors for orders."

/singleton/security_level/default/lbrigdept/general_quarters
...
/singleton/security_level/default/lbrigdept/code_red
	...
	up_description = "A severe non-combat emergency has occurred. All staff are to report to their supervisor for orders. All crew should obey orders from relevant emergency personnel. Masters-at-Arms and Armsmen are permitted to search staff and facilities, and may have weapons unholstered at any time. Saferooms have been unbolted."
	psionic_control_level = PSI_IMPLANT_DISABLED

	var/static/datum/announcement/priority/security/security_announcement_red = new(do_log = 0, do_newscast = 1, new_sound = sound('sound/misc/redalert1.ogg'))

/singleton/security_level/default/lbrigdept/code_red/switching_up_to()
	security_announcement_red.Announce(up_description, "Attention! Code red alert procedures now in effect!")
	notify_station()
	GLOB.using_map.unbolt_saferooms()

/singleton/security_level/default/lbrigdept/code_red/switching_down_to()
	security_announcement_red.Announce("Ship's self-destruct mechanism has been disengaged. All staff are to report to their supervisor for orders. All crew should obey orders from relevant emergency personnel. Security personnel are permitted to search staff and facilities, and may have weapons unholstered at any time.", "Attention! Code red alert procedures now in effect!")
	notify_station()

/singleton/security_level/default/lbrigdept/code_delta
	name = "code delta"
	icon = 'icons/misc/security_state.dmi'
	alarm_level = "on"
...
/singleton/security_level/default/lbrigdept/code_delta/switching_up_to()
	security_announcement_delta.Announce("Ship's self-destruct mechanism has been engaged. All crew are instructed to obey all instructions given by officers. Any violations of these orders can be punished by death. This is not a drill.", "Attention! Delta security level reached!")
	notify_station()
