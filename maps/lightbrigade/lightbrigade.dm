...
//	#include "../torch/structures/closets/security.dm"
	...
	// --- MAP MAINTENANCE --- //
	#include "lightbrigade_areas.dm"
	#include "lightbrigade_elevator.dm"
	#include "lightbrigade_ranks.dm"
	#include "lightbrigade_holodecks.dm"
	#include "lightbrigade_lobby.dm"
	#include "lightbrigade_overmap.dm"
	#include "lightbrigade_presets.dm"
	#include "lightbrigade_security_state.dm"
	#include "lightbrigade_setup.dm"
	#include "lightbrigade_shuttles.dm"

	// --- ITEMS --- //
	#include "items/cards_ids.dm"
	#include "items/headsets.dm"
	#include "items/encryption_keys.dm"
	#include "items/unloaded_guns.dm"
	#include "items/ship_fluff.dm"

	// --- STRUCTURES --- //
	#include "job/structures/closets.dm"
	#include "structures/closets.dm"

	// --- JOB SECTION --- //
	#include "job/loadout/lightbrigade_outfits.dm"

	#include "job/lightbrigade_access.dm"
	#include "job/lightbrigade_jobs.dm"
	#include "job/command_jobs.dm"
	#include "job/engineering_jobs.dm"
	#include "job/medical_jobs.dm"
	#include "job/misc_jobs.dm"
	#include "job/gunnery_jobs.dm"
	...
	#include "../torch_fd/loadout/augments.dm"
	#include "../torch_fd/loadout/overrides.dm"
...
//	#include "../torch_fd/job/posttorch/misc_job.dm"


	// --- MAP FILES --- //

		// ~LIGHTBRIGADE~ //
	#include "lightbrigade_d1.dmm"
	#include "lightbrigade_d2.dmm"
	#include "lightbrigade_d3.dmm"
...
//	#include "../../mods/_fd/_maps/sentinel_fd/_sentinel.dme"
	...
	#define using_map_DATUM /datum/map/lightbrigade

#elif !defined(MAP_OVERRIDE)

	#warn A map has already been included, ignoring Lightbrigade
