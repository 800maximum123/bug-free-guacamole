//Shipbound ID Cards (they have to be here to make the outfits work, no way around it)

/obj/item/card/id/lbrig
	name = "identification card"
	desc = "An identification card issued to personnel aboard the ship."
...
/obj/item/card/id/torch/crew
	desc = "An identification card issued to SolGov crewmembers aboard the ship."
	color = "#d3e3e1"
...
/obj/item/card/id/torch/contractor
	desc = "An identification card issued to private contractors aboard the ship."
	job_access_type = DEFAULT_JOB_TYPE
	color = COLOR_GRAY80
...
/obj/item/card/id/torch/crew/nt_pilot
...
//Misc, used by Torch loadouts and offship maps
