...
#define HUMAN_ONLY_JOBS /datum/job/captain, /datum/job/hop, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos
	species_to_job_blacklist = list(
		...
		/datum/species/machine = list(HUMAN_ONLY_JOBS, /datum/job/bridgeofficer, /datum/job/senior_engineer, /datum/job/qm),
		/datum/species/diona   = list(HUMAN_ONLY_JOBS, /datum/job/officer, /datum/job/doctor),	//Other jobs unavailable via branch restrictions,
	)
#undef HUMAN_ONLY_JOBS
	...
	allowed_jobs = list(
		...
		/*/datum/job/sea,*/
		/datum/job/bridgeofficer, /datum/job/pilot,
		...
		/datum/job/chef, /datum/job/janitor, /datum/job/crew,
		/datum/job/cyborg,
		/datum/job/chaplain,
		/datum/job/assistant,
		/datum/job/merchant
...
// haven't touched this, gotta remove it
/datum/map/lightbrigade/setup_job_lists()
