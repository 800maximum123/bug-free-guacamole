//mostly copypasta. All unneeded Torch access is jury-rigged and temporarily repurposed. It Just Works.
/************
* SEV Torch *
************/
...
/datum/access/aquila
	id = access_aquila
	desc = "Hunter"
	access_type = ACCESS_TYPE_NONE //it isn't used

/var/const/access_aquila_helm = "ACCESS_TORCH_AQUILA_HELM" //79 //scout ship
...
/var/const/access_emergency_armory = "ACCESS_TORCH_ARMORY" //83 //used for tacarm
/datum/access/emergency_armory
	id = access_emergency_armory
	desc = "Tactical Armory"
...
/datum/access/liaison
	...
	access_type = ACCESS_TYPE_NONE //hidden.
...
/var/const/access_expedition_shuttle = "ACCESS_TORCH_EXPLO" //88 //used for dropship
...
var/global/const/access_senadv = "ACCESS_TORCH_SENIOR_ADVISOR" //92 unused
/datum/access/senadv
	id = access_senadv
	desc = "Senior Enlisted Advisor"
	region = ACCESS_REGION_COMMAND

/var/const/access_explorer = "ACCESS_TORCH_EXPLORER" //93 armsman
/datum/access/explorer
	id = access_explorer
	desc = "Armsman"
	region = ACCESS_REGION_SECURITY

/var/const/access_pathfinder = "ACCESS_TORCH_PATHFINDER" //94 armsman lead
/datum/access/pathfinder
	id = access_pathfinder
	desc = "Armsman Team Leader"
	region = ACCESS_REGION_SECURITY
/*
...
/var/const/access_exploration_guard = "ACCESS_TORCH_EXPLORATION_GUARD" //95 armsman engineer
/datum/access/access_exploration_guard
	id = access_exploration_guard
	desc = "Armsman Engineer"
	region = ACCESS_REGION_SECURITY

/var/const/access_commissary = "ACCESS_TORCH_SHOP" //96 //armsman medic
...
// custom-written access - I'm from New Aarhus and I say comment 'em all! (till further notice)
/*
/var/const/access_armsman = "ACCESS_ARMSMAN"
/datum/access/armsman
	id = access_armsman
	desc = "Armsman"
	region = ACCESS_REGION_SECURITY

/var/const/access_armsman_medic = "ACCESS_ARMSMAN_MEDIC"
/datum/access/armsman_medic
	id = access_armsman_medic
	desc = "Armsman Medic"
	region = ACCESS_REGION_SECURITY

/var/const/access_armsman_engi = "ACCESS_ARMSMAN_ENGI"
/datum/access/armsman_engi
	id = access_armsman_engi
	desc = "Armsman Engineer"
	region = ACCESS_REGION_SECURITY

/var/const/access_armsman_lead = "ACCESS_ARMSMAN_LEAD"
/datum/access/armsman_lead
	id = access_armsman_lead
	desc = "Armsman Team Leader"
	region = ACCESS_REGION_SECURITY
*/
