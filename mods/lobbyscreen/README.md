...
- Ассеты - Remission
- Код - SuhEugene
- Арт адаптации Final Destination - appatea
- Адаптация под Final Destination - Lozari/Yarrik (Я ничё впечетляющего не сделал, лишь поменял картинки, низкий поклон тем двоим выше, сделали невероятно красивую вещь)
<!--
