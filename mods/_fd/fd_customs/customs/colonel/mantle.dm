/obj/item/clothing/suit/storage/hooded/sithmantle
	...
	icon = 'mods/_fd/fd_customs/customs/colonel/mantle.dmi'
	icon_state = "item"
	item_state = "mantle_hidden"
	item_flags = ITEM_FLAG_WASHER_ALLOWED
	item_icons = list(
		slot_wear_suit_str = 'mods/_fd/fd_customs/customs/colonel/mantle.dmi'
		)
...
/obj/item/clothing/head/sithmantlehood
	...
	icon_state = "hood"
	item_icons = list(
		slot_head_str = 'mods/_fd/fd_customs/customs/colonel/mantle.dmi'
		)
