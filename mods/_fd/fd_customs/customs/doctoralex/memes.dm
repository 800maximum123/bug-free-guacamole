...
/mob/living/simple_animal/fd/amelia/domain_shadow
	name = "???"
	desc = "???"
	icon = 'mods/_fd/fd_customs/customs/doctoralex/enigma_husks.dmi'
	icon_state = "hollow"
	maxHealth = 99999
	health = 99999

/mob/living/proc/unstable()
	src.overlays += image('mods/_fd/fd_customs/customs/doctoralex/insanity_statuses.dmi', "negative")
...
/datum/sprite_accessory/marking/human/bandages
	...
	icon_state = "bandages"
	icon = 'mods/_fd/fd_customs/customs/doctoralex/bandage.dmi'
...
/obj/item/clothing/under/amelia_skirt
	...
	icon = 'mods/_fd/fd_customs/customs/doctoralex/clothing.dmi'
	item_icons = list(slot_w_uniform_str = 'mods/_fd/fd_customs/customs/doctoralex/clothing_mob.dmi')
	icon_state = "uniskirt"
	worn_state = "uniskirt"
...
/obj/item/clothing/suit/storage/amelia_cape
	...
	icon_state = "cloakalt"
	item_icons = list(
		slot_wear_suit_str = 'mods/_fd/fd_customs/customs/doctoralex/clothing_mob.dmi')
...
/obj/item/gun/energy/amelia_bfg
	...
	icon = 'mods/_fd/fd_customs/customs/doctoralex/bspace.dmi'
	item_icons = list(
		slot_r_hand_str = 'mods/_fd/fd_customs/customs/doctoralex/bspace.dmi',
		slot_l_hand_str = 'mods/_fd/fd_customs/customs/doctoralex/bspace.dmi'
		)
