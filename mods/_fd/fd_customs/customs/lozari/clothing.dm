/obj/item/clothing/under/dark
	...
	icon = 'mods/_fd/fd_customs/customs/lozari/icons/dark_robotist_uniform.dmi'
	icon_state = "dark_robotist"
	item_icons = list(
		slot_w_uniform_str = 'mods/_fd/fd_customs/customs/lozari/onmob/dark_robotist_uniform.dmi')
...
/obj/item/clothing/suit/storage/toggle/labcoat/dark
	...
	icon = 'mods/_fd/fd_customs/customs/lozari/icons/dark_robotist_labcoat.dmi'
...
/obj/item/clothing/gloves/insulated/dark
	...
	icon = 'mods/_fd/fd_customs/customs/lozari/icons/dark_robotist_gloves.dmi'
	icon_state = "dark_robotist"
	body_parts_covered = NONE
	item_icons = list(
		slot_gloves_str = 'mods/_fd/fd_customs/customs/lozari/onmob/dark_robotist_gloves.dmi',
