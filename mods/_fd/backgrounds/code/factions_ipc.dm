...
/singleton/cultural_info/faction/ipc/first
	...
	valid_jobs = list( /datum/job/cargo_tech, /datum/job/janitor, /datum/job/chef, /datum/job/submap/pod, /*/datum/job/submap/citydweller, /datum/job/submap/colonist, /datum/job/submap/colonist2,*/
...
/singleton/cultural_info/faction/ipc/second
	valid_jobs = list(/datum/job/captain, /datum/job/bridgeofficer, /datum/job/chief_engineer,
		/datum/job/engineer, /datum/job/senior_engineer, /datum/job/roboticist,
		/*/datum/job/expmed, /datum/job/expeng,*/ /datum/job/pilot,
		/*/datum/job/junior_doctor, /datum/job/doctor,*/
		/datum/job/janitor, /datum/job/chef, /datum/job/crew,
		/datum/job/cargo_tech, /*/datum/job/submap/pod, /datum/job/submap/citydweller, /datum/job/submap/colonist, /datum/job/submap/colonist2,*/
...
/singleton/cultural_info/faction/ipc/third
	valid_jobs = list(/datum/job/qm,
		/datum/job/bridgeofficer, /datum/job/engineer, /datum/job/senior_engineer, /datum/job/roboticist, /datum/job/pilot,
		/*/datum/job/junior_doctor, /datum/job/doctor, /datum/job/senior_doctor,*/
		/datum/job/officer, /datum/job/armsman, /datum/job/armsman_medic, /datum/job/armsman_engi,
		/datum/job/janitor, /datum/job/chef, /datum/job/crew,
