...
/obj/structure/closet/secure_closet/guncabinet/farfleet/ballistics/WillContain()
	return list(
		...
		/obj/item/gun/projectile/automatic/iccgn/precise = 3,
	)
...
/obj/structure/closet/secure_closet/guncabinet/farfleet/ballistics/WillContain()
	return list(
		/obj/item/gun/projectile/automatic/assault_rifle/heltek = 3,
		/obj/item/gun/projectile/automatic/iccgn/precise = 3,
		/obj/item/gun/projectile/automatic/shotgun/iccgn = 3,
		/obj/item/ammo_magazine/shotgun/iccgn/magnum = 2
	)
...
/obj/structure/closet/secure_closet/guncabinet/farfleet/antitank/WillContain()
	return list(
		...
		/obj/item/gun/energy/ionrifle/small/stupor = 2,
		/obj/item/rcd_ammo = 5,
		/obj/item/gun/projectile/automatic/iccgn/bolter = 1,
		/obj/item/ammo_magazine/rifle/bolter = 3
	)
