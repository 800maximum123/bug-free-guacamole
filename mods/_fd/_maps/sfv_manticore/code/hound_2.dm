...
/datum/shuttle/autodock/overmap/hound_2
	...
	move_time = 20
	range = 0
	shuttle_area = list(/area/ship/hound_2/hull,/area/ship/hound_2/cockpit,/area/ship/hound_2/ammunition,/area/ship/hound_2/engineering,/area/ship/hound_2/reactor)
