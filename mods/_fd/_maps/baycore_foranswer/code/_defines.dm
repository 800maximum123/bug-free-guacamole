...
#define SECONDS_LEFT(world_time, time) ceil((time - world_time) / 10)
...
#define ALL_MECH_EFFECTS list(MECH_OVERHEATED, MECH_CHAINED, MECH_MALFUNCTIONED, MECH_HACKED, MECH_VULNERABLE)
