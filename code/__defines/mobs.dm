...
#define UNRESTRICTED_SPECIES list(SPECIES_HUMAN, SPECIES_RESOMI, SPECIES_TAJARA, SPECIES_DIONA, SPECIES_IPC, SPECIES_UNATHI, SPECIES_YEOSA, SPECIES_SKRELL, SPECIES_TRITONIAN, SPECIES_SPACER, SPECIES_VATGROWN, SPECIES_GRAVWORLDER, SPECIES_MULE)
