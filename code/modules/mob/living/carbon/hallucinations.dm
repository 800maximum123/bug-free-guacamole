...
/datum/hallucination/gunfire/start()
	gunshot = pick('sound/weapons/gunshot/pistol/shot.ogg', 'sound/weapons/gunshot/rifle/shot.ogg', 'sound/weapons/gunshot/shotgun/shot.ogg', 'sound/weapons/gunshot/revolver/shot.ogg','sound/weapons/Taser.ogg')
