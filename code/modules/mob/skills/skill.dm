...
/singleton/hierarchy/skill/security/weapons
	...
	levels = list( "Unskilled"			= "You know how to recognize a weapon when you see one. You can point a gun and shoot it, though results vary wildly. You might forget the safety, you can't control burst recoil well, and you don't have trained reflexes for gun fighting.<br>- You can load and shoot a firearm, but you're likely to miss or cause a malfunction.<br>- You might fire your weapon randomly.",
						"Basic"				= "You know how to handle weapons safely, and you're comfortable using simple weapons. Your aim is decent and you can usually be trusted not to do anything stupid with a weapon you are familiar with, but your training isn't automatic yet and your performance will degrade in high-stress situations.<br>- You no longer cause malfunctions during normal operation.<br>- Examining a firearm you are carrying lets you see the contents of the chamber.",
						"Trained"			= "You have had extensive weapons training, or have used weapons in combat. Your aim is better now. You are familiar with most types of weapons and can use them in a pinch. You have an understanding of tactics, and can be trusted to stay calm under fire. You may have military or police experience and you probably carry a weapon on the job.<br>- Examining a firearm you are carrying lets you see the amount of shots remaining.<br>- You automatically run the action if your weapon fails to fire, fixing some malfunctions.<br>- You have a chance to automatically unsafety a gun when firing on harm intent.",
						...
						"Master"		= "You are an exceptional shot with a variety of weapons, from simple to exotic. You use a weapon as naturally as though it were a part of your own body. You may be a sniper or special forces operator of some kind.<br>- You get extra accuracy for sniper rifles.<br>- You automatically eject shells from bolt-action firearms.<br>- You can completely manipulate some weapons with only one hand, including reloading. This also allows you to automatically clear malfunctions on these weapons one-handed.")
