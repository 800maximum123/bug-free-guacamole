...
/obj/item/pen/crayon/use_after(atom/target, mob/user)
	if(istype(target,/turf/simulated/floor))
		var/drawtype = input("Choose what you'd like to draw.", "Crayon scribbles") in list("graffiti", "rune", "letter", "arrow", "gaia-protestor graffiti", /*"defector graffiti"*/)
		switch(drawtype)
			if("letter")
			...
			if("gaia-protestor graffiti")
				to_chat(user, "You start drawing anti-imperalist graffiti on the [target.name].")
