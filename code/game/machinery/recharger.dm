...
/obj/machinery/recharger/wallcharger
	...
	allowed_devices = list(/obj/item/gun/magnetic/railgun, /obj/item/gun/energy, /obj/item/melee/baton/stun, /obj/item/device/radio)
