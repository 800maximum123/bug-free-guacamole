...
/area
	...
	/// Area-based ambient light registration.
	var/ambient_group_type = null
	var/ambient_group_color = null
	var/ambient_group_multiplier = 1.0
	var/ambient_group_enabled = FALSE
